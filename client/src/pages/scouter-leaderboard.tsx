                  ...
                  {filteredScouters.map((scouter) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell
                          className={`text-center font-bold text-base tabular-nums ${repColor}`}
                          data-testid={`stat-rep-${scouter.id}`}
                        >
                          {scouter.rep}
                        </TableCell>
                        <TableCell
                          className={`text-center font-medium tabular-nums ${entriesColor}`}
                          data-testid={`stat-entries-${scouter.id}`}
                        >
                          {scouter.entryCount}
                        </TableCell>
                        <TableCell
                          className={`text-center font-medium tabular-nums ${eventsColor}`}
                          data-testid={`stat-events-${scouter.id}`}
                        >
