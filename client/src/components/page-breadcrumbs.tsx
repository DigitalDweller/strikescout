...
export function PageBreadcrumbs() {
  ...
  const eventHomeHref = user?.role === "demo" ? `${basePath}/teams` : basePath;

  const crumbs: { label: string; href?: string }[] = [
    { label: eventName, href: eventHomeHref },
  ];
  ...
  } else if (location.includes("/pit-scout")) {
    crumbs.push({ label: "Pit scouting" });
  ...
  } else if (location.includes("/alliance-sim")) {
    crumbs.push({ label: "Alliance sim" });
