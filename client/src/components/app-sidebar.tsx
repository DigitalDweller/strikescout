  ...
  const demoSections = [
    {
      ...
      items: [
        { title: "Teams", url: `/events/${eventId}/teams`, icon: Users, iconClass: "text-blue-500" },
        {
          ...
          children: [
            { title: "Match Simulator", url: `/events/${eventId}/simulator`, icon: BarChart2, iconClass: "text-amber-500" },
          ],
        },
      ],
    },
    ...
    ? [
        {
          ...
          items: [
            ...
            iconClass: "text-sky-500",
            children: [
              { title: "Scouter Management", url: `/events/${eventId}/scouting-schedule`, icon: CalendarCheck, iconClass: "text-emerald-500" },
              { title: "Match Simulator", url: `/events/${eventId}/simulator`, icon: BarChart2, iconClass: "text-amber-500" },
            ],
          },
          ],
    ...
    <Sidebar>
      <SidebarHeader>
        <div className="px-3 py-4">
          {!isDemo && (
          <Button variant="ghost" className="mb-3 h-auto px-0 py-0 text-sm text-muted-foreground hover:text-foreground" asChild>
            <Link href="/" data-testid="button-back-events">
