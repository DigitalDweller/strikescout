...
The app runs on **one port** (default **5050 on Windows**, **5000 on Linux/Replit**). In development, the server starts Vite’s dev server so you get hot reload.
...
| Port in use | Set `PORT=5051` (or another port) in `.env`. |
